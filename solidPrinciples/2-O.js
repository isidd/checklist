...
/*   
each if condition or type or role condition should have a separate class defined
*/

function PrintQuizWrong(question) {
...
PrintQuizWrong(questions);

// ========================================================================================
// create a separate class for the question type to handle switch conditions

function PrintQuizRight(question) {
